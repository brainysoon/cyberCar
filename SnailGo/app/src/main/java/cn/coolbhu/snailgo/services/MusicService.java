package cn.coolbhu.snailgo.services;
...
import cn.coolbhu.snailgo.IMusicService;
import cn.coolbhu.snailgo.R;
import cn.coolbhu.snailgo.helpers.MediaButtonIntentReceiver;
import cn.coolbhu.snailgo.helpers.MusicPlaybackTrack;
import cn.coolbhu.snailgo.permissions.Nammu;
import cn.coolbhu.snailgo.providers.MusicPlaybackState;
import cn.coolbhu.snailgo.providers.RecentStore;
import cn.coolbhu.snailgo.providers.SongPlayCount;
...
public class MusicService extends Service {
    public static final String PLAYSTATE_CHANGED = "cn.coolbhu.snailgo.playstatechanged";
    public static final String POSITION_CHANGED = "cn.coolbhu.snailgo.positionchanged";
    public static final String META_CHANGED = "cn.coolbhu.snailgo.metachanged";
    public static final String QUEUE_CHANGED = "cn.coolbhu.snailgo.queuechanged";
    public static final String PLAYLIST_CHANGED = "cn.coolbhu.snailgo.playlistchanged";
    public static final String REPEATMODE_CHANGED = "cn.coolbhu.snailgo.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "cn.coolbhu.snailgo.shufflemodechanged";
    public static final String TRACK_ERROR = "cn.coolbhu.snailgo.trackerror";
    public static final String TIMBER_PACKAGE_NAME = "cn.coolbhu.snailgo";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "cn.coolbhu.snailgo.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "cn.coolbhu.snailgo.togglepause";
    public static final String PAUSE_ACTION = "cn.coolbhu.snailgo.pause";
    public static final String STOP_ACTION = "cn.coolbhu.snailgo.stop";
    public static final String PREVIOUS_ACTION = "cn.coolbhu.snailgo.previous";
    public static final String PREVIOUS_FORCE_ACTION = "cn.coolbhu.snailgo.previous.force";
    public static final String NEXT_ACTION = "cn.coolbhu.snailgo.next";
    public static final String REPEAT_ACTION = "cn.coolbhu.snailgo.repeat";
    public static final String SHUFFLE_ACTION = "cn.coolbhu.snailgo.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "cn.coolbhu.snailgo.refresh";
    public static final String UPDATE_LOCKSCREEN = "cn.coolbhu.snailgo.updatelockscreen";
    ...
    private static final String SHUTDOWN = "cn.coolbhu.snailgo.shutdown";
    ...
    private Notification buildNotification() {
        ...
        if (PreferencesUtils.getInstance(this).getXPosedTrackselectorEnabled()) {
            addXTrackSelector(n);
        }
    ...
    public void enqueue(final long[] list, final int action, long sourceId, MusicUtils.IdType sourceType) {
        synchronized (this) {
...
//            }
    ...
    private static final class ServiceStub extends IMusicService.Stub {
        ...
        public void open(final long[] list, final int position, long sourceId, int sourceType)
            ...
            mService.get().open(list, position, sourceId, MusicUtils.IdType.getTypeById(sourceType));
        }
        ...
        public void enqueue(final long[] list, final int action, long sourceId, int sourceType)
                throws RemoteException {
            mService.get().enqueue(list, action, sourceId, MusicUtils.IdType.getTypeById(sourceType));
        }
