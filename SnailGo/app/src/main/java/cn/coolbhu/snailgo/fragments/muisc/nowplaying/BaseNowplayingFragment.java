...
import cn.coolbhu.snailgo.adapters.BaseQueueAdapter;
import cn.coolbhu.snailgo.dataloaders.QueueLoader;
...
import cn.coolbhu.snailgo.views.CircularSeekBar;
import cn.coolbhu.snailgo.views.DividerItemDecoration;
import cn.coolbhu.snailgo.views.PlayPauseButton;
import cn.coolbhu.snailgo.views.PlayPauseDrawable;
import cn.coolbhu.snailgo.views.TimelyView;
...
//        mCircularProgress = (CircularSeekBar) view.findViewById(R.id.song_progress_circular); //3没有

//        recyclerView = (RecyclerView) view.findViewById(R.id.queue_recyclerview);  //3没有
