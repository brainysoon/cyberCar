...
public class NotificationUtil {
    ...
    public void sendNotification(String str) {
        ...
        PendingIntent intent = PendingIntent.getActivity(context, 0,
                new Intent(context, MyCarsActivity.class), 0);
        ...
        Notification notify2 = new Notification.Builder(context)
                ...
                // bar上显示的提示文字
                .setContentTitle("汽车维护")// 设置在下拉status
                // bar后Activity，本例子中的NotififyMessage的TextView中显示的标题
                .setContentText("你有新的汽车维护信息")// TextView中显示的详细内容
                .setContentIntent(intent) // 关联PendingIntent
