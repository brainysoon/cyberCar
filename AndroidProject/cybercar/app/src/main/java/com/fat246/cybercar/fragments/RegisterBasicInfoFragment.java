...
public class RegisterBasicInfoFragment extends Fragment {
    ...
    //跳转
    private canSkipToDetailInfo mSkip;

    //一个让  Activity 跳转的接口
    public interface canSkipToDetailInfo {

        void skipToDetailInfo();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContext = getContext();
//        mSkip = (RegisterActivity) getActivity();
    }
    ...
    private void findView(View rootView) {
        ...
        mTabLayout = (TabLayout) rootView.findViewById(R.id.fragment_register_basic_info_tablayout);
    }
