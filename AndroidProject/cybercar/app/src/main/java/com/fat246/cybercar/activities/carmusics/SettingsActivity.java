...
import com.fat246.cybercar.fragments.SettingsFragmentback;
import com.fat246.cybercar.subfragments.StyleSelectorFragment;
...
public class SettingsActivity extends BaseThemedActivity implements ColorChooserDialog.ColorCallback, ATEActivityThemeCustomizer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settingsback);
        ...
        if (action.equals(Constants.SETTINGS_STYLE_SELECTOR)) {
            ...
            PreferenceFragment fragment = new SettingsFragmentback();
    ...
    public void onColorSelection(@NonNull ColorChooserDialog dialog, @ColorInt int selectedColor) {
        ...
        config.commit();
        recreate(); // recreation needed to reach the checkboxes in the preferencesback layout
    }
